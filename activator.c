...
Activator *activator_relu() {
    if (!relu_instance) {
        relu_instance = activator_create();
...
Activator *activator_leaky_relu() {
    if (!leaky_relu_instance) {
        leaky_relu_instance = activator_create();
...
Activator *activator_equal() {
    if (!equal_instance) {
        equal_instance = activator_create();
